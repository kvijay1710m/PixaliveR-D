        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="mb-4">
                <Link to="/services" className="relative group hover:text-gray-400">Services<span className="absolute left-0 bottom-0 w-0 h-[3px] bg-red-400 group-hover:w-full transition-all duration-400"></span>
                </Link>
              </li>
              <li className="mb-4">
                <Link to="/blog" className="relative group hover:text-gray-400"> Blog<span className="absolute left-0 bottom-0 w-0 h-[3px] bg-red-400 group-hover:w-full transition-all duration-400"></span>
                </Link>
              </li>
              <li className="mb-4">
                <Link to="/careers" className="relative group hover:text-gray-400">Careers  <span className="absolute left-0 bottom-0 w-0 h-[3px] bg-red-400 group-hover:w-full transition-all duration-400"></span>
                </Link>
              </li>
              <li className="mb-4">
